...
export abstract class FlareService extends FlareBase {
  /** Called once when a singleton service starts (FlareApp.start()). Not called for scoped services. */
  onStart?(): Promise<void> | void;

  /** Called once when a singleton service stops (FlareApp.stop()). Not called for scoped services. */
