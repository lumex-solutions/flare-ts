...
function isConfigFieldRequired(descriptor: DescriptorValue<unknown> | undefined): boolean {
  ...
  if (typeof descriptor === "function") {
    // Primitive parsers are the only callable members of DescriptorValue; the typeof
    // check selects them at runtime but does not narrow the union for the checker.
