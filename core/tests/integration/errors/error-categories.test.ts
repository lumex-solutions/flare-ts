...
import { flareErrorCodes } from "../../../src/lib/errors/flare-error-codes.js";
import { FlareError } from "../../../src/lib/errors/flare-error.js";
import { type CodeDescriptor, FlareErrorCategories } from "../../../src/lib/errors/types/types.js";
import { FlareHost } from "../../../src/lib/host/flare-host.js";
import { node } from "../../../src/lib/host/runtime/node.js";

// Per-category descriptors. Each carries a distinct name and the spec's
// documented category, so a route that throws `new FlareError(<descriptor>)`
// exercises the FlareErrorCategories[category] -> HTTP status mapping in the
// HTTP arc's default error handler (handleControllerError).
