...
// Helpers
//
// Every test builds its own FlareHost so registration mutations from one test
// do not leak into another. `composition-root` behavior is asserted through
// observable outputs (controller responses, host getters, thrown errors)
// rather than by probing private state.
