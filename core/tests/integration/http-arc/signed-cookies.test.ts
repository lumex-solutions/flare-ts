...
// every other http-arc behavior test file in the package.
...
// Pulls the single drained Set-Cookie line, preferring getSetCookie() for the
// unambiguous per-cookie split and falling back to the combined header.
