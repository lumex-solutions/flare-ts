...
// ---------------------------------------------------------------------------
// Fake stub: records the Request its fetch() was called with, exposes an RPC
// method and Symbol.dispose to prove passthrough.
// ---------------------------------------------------------------------------
...
describe("wrapStub() strips reserved headers on .fetch()", () => {
...
// ---------------------------------------------------------------------------
// Integration through durable() itself: a fake namespace whose getByName returns
// the fake stub, proving durable() returns the wrapped (sanitizing) stub.
// ---------------------------------------------------------------------------
