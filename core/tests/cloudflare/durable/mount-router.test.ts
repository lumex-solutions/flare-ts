// Conflict-matrix tests for the explicit per-DO room.mount(path) API.
// Validation 1 (call-time): path shape errors throw immediately at mount().
// Validation 2 (build-time): subtree overlap with developer routes or other mounts throws at host.build().
// End-to-end: forwarding strip + instance decode.
...
// ---- Validation 1: call-time path shape ----

describe("mount() Validation 1: call-time path shape errors", () => {
...
// ---- Validation 2: build-time conflict matrix ----

describe("mount() Validation 2: build-time subtree-conflict matrix", () => {
