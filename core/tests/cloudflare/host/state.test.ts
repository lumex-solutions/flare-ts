...
import { buildCf } from "../../../src/lib/host/runtime/cloudflare/index.js";

describe("Primary Behavior", () => {
  it(
    "Cloudflare runtime: host.state reads 'ready' once worker() returns",
    () => {
      // The worker() terminal sets host.state to "ready" synchronously after
