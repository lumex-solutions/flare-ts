...
describe("per-DO route arcs", () => {
  it("registering a durable object yields a distinct per-instance HTTP arc handle separate from the front door", () => {
  ...
  it("a DO instance dispatches through its OWN per-DO arc, not host.http", async () => {
    ...
    // The front-door route is not visible to the DO arc; expect 404.
