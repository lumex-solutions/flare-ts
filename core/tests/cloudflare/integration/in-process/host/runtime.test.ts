...
describe("Edge Cases", () => {
  ...
  it(
    ...
    async () => {
      ...
      // per distinct Set-Cookie header, which proves the
...
describe("Cross-Feature Interactions", () => {
  it(
    ...
    async () => {
      ...
      // The same worker reuses one nonce; sequence is strictly monotone across
    ...
    async () => {
      ...
      host.http.post(
        ...
        async (ctx) => {
          ...
          // signal and nativeRequest must be wired through from the CF
  ...
  it(
    ...
    async () => {
      const StreamContract = httpContract({
