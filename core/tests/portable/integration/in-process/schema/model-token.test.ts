/**
 * In-process integration tests for schema-branded model instances serialized
 * through the HTTP transport layer via well-known Symbol.for lookups.
...
/** Well-known compiled-serializer symbol read the same way the transport layer resolves it. */
