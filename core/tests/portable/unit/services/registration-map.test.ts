/**
 * Unit tests for {@link FlareRegistrationMap} token storage and lookup.
 */
...
describe("registering service tokens", () => {
...
describe("looking up service registrations", () => {
  it("returns the stored ServiceRegistration<T> for a known token", () => {
    const map = new FlareRegistrationMap();
...
describe("iterating registered tokens", () => {
