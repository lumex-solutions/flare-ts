/**
 * Unit tests for {@link FlareBase} inject, config access, and {@link Injected} type projection.
 */
...
/**
 * Rich service declaring framework members plus a domain method for
 * `Injected<T>` projection tests where the runtime object retains those members.
 */
...
describe("base class container wiring", () => {
...
describe("declared dependency injection", () => {
...
describe("declared config token access", () => {
