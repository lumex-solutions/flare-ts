/**
 * Unit tests for {@link CaptiveDependencyValidator} singleton-on-scoped dependency rules.
 */
...
import { CaptiveDependencyValidator } from "../../../../../src/lib/validation/service/captive-dependency-validator.js";

/**
 * Returns a minimal FlareServiceClass with the supplied dependency tokens.
 * CaptiveDependencyValidator inspects `reg.cls.deps` and token identity only.
 */
...
/** Returns a ServiceRegistration whose `cls` is the supplied class and whose token is itself. */
...
/** Returns a ServiceValidationContext from optional overrides. */
...
describe("captive singleton dependencies on scoped services", () => {
