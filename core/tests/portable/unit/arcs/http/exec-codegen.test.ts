/**
 * Unit tests for exec-shape cache helpers and `compileExecFn` pipeline execution, including
 * middleware short-circuit, finally LIFO order, body preparation, and error-handler dispatch.
 */
...
/**
 * Builds a {@link Pipeline} with the given middleware exec indices and controller handler.
 * Handlers are exposed at index 0 (GET slot).
 */
