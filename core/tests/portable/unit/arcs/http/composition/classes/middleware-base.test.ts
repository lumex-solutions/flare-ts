/**
 * Unit tests for MiddlewareBase response helpers exposed through a test subclass.
 */
...
describe("MiddlewareBase response helpers", () => {
  it("returns the expected error status codes with JSON bodies for each error response helper", () => {
