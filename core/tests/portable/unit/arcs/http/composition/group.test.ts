/**
 * Unit tests for HttpGroup prefix validation, registration, and register() snapshots.
 */
...
describe("group prefix validation and parent identification", () => {
...
describe("isolated group flag", () => {
  it("sets the isolated flag and returns the group for chaining", () => {
...
describe("global middleware exclusion list", () => {
...
describe("middleware replacement mapping", () => {
...
describe("group registration snapshot", () => {
  let group: HttpGroup;
  ...
  it("attaches group scope metadata to every controller registration", () => {
    group.controller("/a", CtrlA);
    group.controller("/b", CtrlB);
    group.use(MwA);
