/** Unit tests for CookieSigner sign and verify round-trips. */
...
describe("CookieSigner round-trip", () => {
  ...
  it("round-trips values containing cookie delimiters, whitespace, and Unicode", async () => {
    const signer = new CookieSigner(SECRET);
    const values = [
...
describe("minimum secret length enforcement", () => {
