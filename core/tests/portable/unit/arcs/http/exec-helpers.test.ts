/**
 * Unit tests for `handleControllerError`, `dispatchErrorHandlers`, and `prepareRequestBody`.
 * The latter two resolve `Logger` from a container; tests use a recording fake logger.
 */
