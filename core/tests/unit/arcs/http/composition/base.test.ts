...
describe("HttpBase.use", () => {
  ...
  it("pushes a MiddlewareRegistration with the class and a factory", () => {
    ...
    // The factory constructs the supplied class with (container, ctx).
...
describe("HttpBase.before / after / finally (synthetic middleware)", () => {
  let base: TestHttpBase;
  beforeEach(() => {
    base = new TestHttpBase();
  });
...
describe("HttpBase.controller", () => {
  ...
  it("adds a ControllerRegistration with fullPath computed via #fullPath", () => {
...
describe("HttpBase.get / post / put / patch / delete / head / options (synthetic controller)", () => {
  let base: TestHttpBase;
  beforeEach(() => {
    base = new TestHttpBase();
  });
...
describe("HttpBase.#assertPath (via public APIs)", () => {
  let base: TestHttpBase;
  beforeEach(() => {
    base = new TestHttpBase();
  });
