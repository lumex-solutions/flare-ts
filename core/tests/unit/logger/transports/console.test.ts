...
describe("CFWConsoleTransport", () => {
  ...
  describe("#errorBlock frame width via cfFrameWidth()", () => {
...
describe("formatting helpers (exercised via ConsoleTransport)", () => {
  ...
  describe("formatPrettyValue (key/value formatting in sections)", () => {
  ...
  describe("formatPrettyKey (camelCase → snake_case)", () => {
  ...
  describe("colorSectionLabel (label colors by raw name)", () => {
  ...
  describe("sectionEntries via context/state rendering", () => {
  ...
  describe("formatStack (empty / undefined)", () => {
  ...
  describe("formatInspectable / formatInspectableValue (via meta block)", () => {
  ...
  describe("toJsonRecord(record) field inclusion order", () => {
