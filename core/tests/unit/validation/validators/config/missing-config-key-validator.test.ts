...
/**
 * Build a minimal `ConfigValidationContext`. By default, descriptor field values
...
/** Build an `OpaqueConfigToken` with the given key and optional descriptor field names. */
...
describe("MissingConfigKeyValidator.validate", () => {
