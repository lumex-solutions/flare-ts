...
describe("optional primitive wrapping", () => {
  ...
  it("throws for undefined input", () => {
    const maybeInt = optional(int);
    expect(() => maybeInt(undefined as never)).toThrow("optional primitive received undefined");
  });
...
describe("defaultTo primitive wrapping", () => {
  ...
  it("throws for undefined input", () => {
    const countOrZero = defaultTo(0, int);
    expect(() => countOrZero(undefined as never)).toThrow("defaultTo primitive received undefined");
  });
